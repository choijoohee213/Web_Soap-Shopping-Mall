...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/find_id.css">
...
<body>
  ...
  <div class="content">
    <center>
      ...
      <form action="/treesoap/find_id_process.php" id="find_idform" class="find_idform" method="POST">
        <div class="form">
          <div class="input">
            <label class="legend"></label>
            <input name="username" id="username" type="text" placeholder="이름" style="width:170px;height:30px; margin:3px;" required>
            <label class="legend"></label>
            <input name="email" id="email" type="text" placeholder="가입 메일주소" style="width:170px;height:30px; margin:3px;" required>
          </div>
          <div class="btn"><button class="button6">아이디찾기</button></div>
        </div>
      </form>

      <div class="blank"></div>
      <div class="btn-group7">
        <button class="button7" style="background-color: #6fa56f">로그인</button>
        <button class="button7" style="background-color: #a4d18e">비밀번호 찾기</button>
      </div>
