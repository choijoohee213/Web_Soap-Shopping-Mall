...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/goods_list.css">
...
<body>
  ...
  <div style="style=margin-top: 34px;margin-top: 60px;margin-left: 43vw;margin-bottom: 12px;">
    <img class="main_soap_box_tite" src="/treesoap/img/trees.png" alt="나무웹용이미지">
    <p class="main_soap_box_tite2">제품 구매</p>
    <img class="main_soap_box_tite" src="/treesoap/img/trees.png" alt="나무웹용이미지">
  </div>
  <div class="tmp"> </div>
    ...
    <div>
      ...
      <div class="temp">
        <a style="text-decoration:none;" href="/treesoap/goods_view1.php">
          ...
          <div class="product_text_explanation">
            <strong class="b">#트리솝#상큼상큼#새로운샤워</strong>
          </div>
          <div class="product_text_price">
            <strong class="c">10,000원</strong>
          </div>
        </a>
      </div>
      ...
      <div class="temp">
        <a style="text-decoration:none;" href="/treesoap/goods_view2.php">
          ...
          <div class="product_text_explanation">
            <strong class="b">#트리솝#달콤부드러운바닐라#오늘의주인공</strong>
          </div>
          <div class="product_text_price">
            <strong class="c">9,000원</strong>
          </div>
      ...
      <div class="temp">
        <a style="text-decoration:none;" href="/treesoap/flowersoap.php">
          ...
          <div class="product_text_explanation">
            <strong class="b">#트리솝#청정한향기의 솝#복합성</strong>
          </div>
          <div class="product_text_price">
            <strong class="c">7,000원</strong>
          </div>
