...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/goods_view2.css">
...
<body onload="init();">
  ...
  <div>
    <div class="left">
      <img class="product" src="/treesoap/img/green.jpg" alt="올리브 비누">
    </div>
    ...
    <div class="product_top">
      ...
      <li>
        <h3>
          <font size="2pt" font color="gray">#트리솝#클렌징#건성#촉촉#올리브오일#부드러움
        </h3>
      </li>
      <p class="a">
        <li>
          <font size="2pt" font color="#555"><b>판매가</b>
            <font size="4pt" font color="green"><b> 12,000</b>
        ...
        <div class="top">
          <div class="pricebox">
            ...
            <form name="form" method="get">
              <input name="prd_id" type="hidden" value="2" />
              <p style="margin-left:10px; margin-top:8px;">
                수량 : <input type=hidden name="sell_price" value="12000">
              ...
              <p style="margin-left:10px;margin-top:5px;">
                적립금 : <input style="border:0px; background-color:#f0ffe5; text-align:right; font-size:15px;" type="text" value="120" name="mileage" size="8" readonly />원
              </p>
  ...
  <div class="main" id="prddetail" style="margin-top:80px;">
    <center>
      <br><br>
      <div class="link">
    ...
    ">
      ...
      <div style="margin-bottom:10vw;">
        ...
        <img src="/treesoap/img/goods2_detail.jpg" alt="성분">

        <img class="wash" src="/treesoap/img/wash.jpg" alt="사람씻는거">
        ...
        <div id="write-layer" class="write-layer animate">
          ...
          <form class="modal-content" name="frmWrite" id="frmWrite" method="post">
            ...
            <div class="scroll-box">
              <div class="goods">
                <div class="thumbnail">
                  <img width="900" title="올리브 비누" class="middle" alt="올리브비누" src="/treesoap/img/greenclean.png">
                </div>
                <div class="txt">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <input name="writerNm" type="hidden" value="유혜원">
                      </td>
                    </tr>
                    <tr>
                      <th>제목</th>
                    ...
                    <tr>
                      ...
                      <td id="uploadBox">
                        <div class="file_input">
                          <input type="text" id="file_route" value="/treesoap/img/greenclean.png" name="review_photo">
                          <label>
                            파일선택
...
?>
    ...
    font-family:맑은 고딕; margin-top:20px; ">
        ...
        $query = "SELECT * from board_ask WHERE prd_id=2 order by num  desc limit $no,$page_size ";  //limit 시작 인덱스, 레코드갯수

        $result = mysqli_query($conn,$query); //전체 레코드 개수 계산
        $result_count=mysqli_query($conn,"SELECT count(*) from board_ask WHERE prd_id=2");
        $result_row=mysqli_fetch_array($result_count);
        $total_row=$result_row[0];
                ...
                <table border="1" cellpadding="0" summary="글쓰기 폼입니다.">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td id="uploadBox">
                        <div class="file_input">
                          <input type="text" id="file_route" value="/treesoap/img/greenclean.png" name="ask_photo">
                          <label>
                            파일선택
                            <input type="file" onchange="javascript: document.getElementById('file_route').value=this.value">
                          </label>
