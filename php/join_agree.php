...
<link rel="stylesheet" type="text/css" href="/treesoap/css/join_agree.css">
</head>
...
<body>
  ...
  <div class="content">
    <form id="formTerms" name="formTerms" method="post">
      ...
      <p class="all-agree">
        <input type="checkbox" class="checkbox" id="allAgree" name="allAgree" onclick="chkall(1)" style="cursor:pointer;">
        <label for="allAgree" style="cursor:pointer;">
          <span><strong>TREESOAP의 모든 약관을 확인하고 전체 동의합니다.</strong></span>
          (전체동의, 선택항목도 포함됩니다.)
        </label>
      </p>
      <br />
      ...
      <script type="text/javascript">
        function chkall(v) {
          ...
          var c0 = document.getElementById("allAgree");
          var c1 = document.getElementById("agreementInfoFl");
          var c2 = document.getElementById("agreementInfoF2");
          var c3 = document.getElementById("agreementInfoF3");
          var c4 = document.getElementById("agreementInfoF4");
          var c5 = document.getElementById("agreementInfoF5");


          if (v == 1) {
            c1.checked = c0.checked;
            c2.checked = c0.checked;
            c3.checked = c0.checked;
            c4.checked = c0.checked;
            c5.checked = c0.checked;
          }
        }
        ...
        function agreechk(v) {
          ...
          if (v == 1) {
            if (!((c1.checked) && (c2.checked))) {
              ...
              location.href = "/treesoap/join.php";
            }
          }
      ...
      <div class="terms-view">
        <p>
          <input type="checkbox" id="agreementInfoFl" name="agreementInfoFl" style="cursor:pointer;">
          <label for="agreementInfoFl" style="cursor:pointer;">
        ...
        <br />
        <textarea id="agreetext" readonly cols="80" rows="10">
제1조(목적)

표준약관 제10023호

이 약관은 (주)순녹 회사(전자거래 사업자)가 운영하는 순녹 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
① "몰"이란 (주)순녹 회사가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
③ "몰"은 약정에 따라 이용자에게 귀속된 저작권을 사용하는 경우 당해 이용자에게 통보하여야 합니다.
      ...
      <div class="terms-view">
        <p>
          <input type="checkbox" id="agreementInfoF2" name="agreementInfoF2" style="cursor:pointer;">
          <label for="agreementInfoF2" style="cursor:pointer;">
            <span><strong>(필수)</strong></span>
            개인정보 수집 및 이용
          </label>
        </p>
...
3. - 목적 : 만 14세 미만 아동 확인
   ...
   - 보유 및 이용기간 : 회원탈퇴 후 5일까지
      ...
      <div class="terms-view">
        <p>
          <input type="checkbox" id="agreementInfoF3" name="agreementInfoF3" style="cursor:pointer;">
          <label for="agreementInfoF3" style="cursor:pointer;">
            <span class="option"><strong>(선택)</strong></span>
            개인정보 수집 및 이용 - 주문/결제 및 배송서비스
          </label>
        </p>
        <br />
        <textarea id="agreetext" readonly cols="80" rows="10">
...
- 보유/이용기간 : 회원탈퇴 후 5일까지
      ...
      <div class="terms-view">
        <p>
          <input type="checkbox" id="agreementInfoF4" name="agreementInfoF4" style="cursor:pointer;">
          <label for="agreementInfoF4" style="cursor:pointer;">
            <span class="option"><strong>(선택)</strong></span>
            개인정보 제 3자 제공 - 마케팅 활용을 위한 개인정보 제3자 제공 동의
          </label>
        </p>
        <br />
        <textarea id="agreetext" readonly cols="80" rows="10">
...
- 보유/이용기간 : 회원탈퇴 후 5일까지
      ...
      <div class="terms-view">
        <p>
          <input type="checkbox" class="checkbox" id="agreementInfoF5" name="agreementInfoF5" style="cursor:pointer;">
          <label for="agreementInfoF5" style="cursor:pointer;">
            <span class="option"><strong>(선택)</strong></span>
            개인정보 제 3자 제공 - 공급사 상품 판매 및 배송을 위한 개인정보 제3자 제공 동의
          </label>
        </p>
        <br />
        <textarea id="agreetext" readonly cols="80" rows="10">
- 제공받는 자 : 공급사, 판매자/ (주)TREESOAP
...
- 보유/이용기간 : 배송완료 후 한달
      ...
      <button class="button6" type="submit" id="btnPrevStep" onclick="location.href='/treesoap/index.php';" style="background-color: #6fa56f">이전단계</button>
      <form action="/treesoap/join.php">
        <input type="button" class="button7" id="btnNextStep" onclick="agreechk(1);" value="다음단계" style="background-color: #a4d18e">
      </form>
    </form>
  </div>
