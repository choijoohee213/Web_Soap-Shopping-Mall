...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/goods_view1.css">
...
<body onload="init();">
  ...
  <div name="goods_1">
    <div class="left">
      <img class="product" src="/treesoap/img/blue.png" alt="유칼립투스 비누">
    </div>
    ...
    <div class="product_top">
      ...
      <li>
        <h3>
          <font size="2pt" font color="gray">#트리솝#클렌징#지성#페퍼민트#유칼립투스#시원
        </h3>
      </li>
      <p class="a">
        <li>
          <font size="2pt" font color="#555"><b>판매가</b>
            <font size="4pt" font color="green"><b> 9,000</b>
        ...
        <div class="top">
          <div class="pricebox">
            ...
            <form name="form" method="get">
              <input name="prd_id" type="hidden" value="1" />
              <p style="margin-left:10px; margin-top:8px;">
                수량 : <input type=hidden name="sell_price" value="9000">
              ...
              <p style="margin-left:10px;margin-top:5px;">
                적립금 : <input style="border:0px; background-color:#f0ffe5; text-align:right; font-size:15px;" type="text" value="90" name="mileage" size="8" readonly />원
              </p>
  ...
  ">
      ...
      <div style="margin-bottom:10vw;">
        ...
        <img src="/treesoap/img/goods1_detail.jpg" alt="성분">
  ...
  <div class="main" id="prdreview">
    ...
    font-weight: bold; ">
      ...
      <a href="#" class="linkbtn" style="margin-right:5vw;">
        상품문의
      </a>
    </div>
...
$query = "SELECT * from board_review WHERE prd_id=1 order by id desc limit $no,$page_size";  //limit 시작 인덱스, 레코드갯수

$result = mysqli_query($conn,$query); //전체 레코드 개수 계산
$result_count=mysqli_query($conn,"SELECT count(*) from board_review WHERE prd_id=1");
        ...
        <div id="write-layer" class="write-layer animate">
          ...
          <form class="modal-content" name="frmWrite" id="frmWrite" method="post">
            ...
            <div class="scroll-box">
              <div class="goods">
                <div class="thumbnail">
                  <img width="900" title="유칼립투스 비누" class="middle" alt="유칼립투스비누" src="/treesoap/img/blueclean.png">
                </div>
                <div class="txt">
                    ...
                    <tr>
                      ...
                      <td id="uploadBox">
                        <div class="file_input">
                          <input type="text" id="file_route" value="/treesoap/img/blueclean.png" name="review_photo">
                          <label>
                            파일선택
...
?>
    ...
    font-family:맑은 고딕; margin-top:20px; ">
        <table class="asktable" style=" border-top: 2px solid #dbdbdb; width:100%;">
          ...
          $query = "SELECT * from board_ask WHERE prd_id=1 order by num  desc limit $no,$page_size ";  //limit 시작 인덱스, 레코드갯수

          $result = mysqli_query($conn,$query); //전체 레코드 개수 계산
          $result_count=mysqli_query($conn,"SELECT count(*) from board_ask WHERE prd_id=1");
          $result_row=mysqli_fetch_array($result_count);
          $total_row=$result_row[0];
                ...
                <table border="1" cellpadding="0" summary="글쓰기 폼입니다.">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td id="uploadBox">
                        <div class="file_input">
                          <input type="text" id="file_route" value="/treesoap/img/blueclean.png" name="ask_photo">
                          <label>
                            파일선택
                            <input type="file" onchange="javascript: document.getElementById('file_route').value=this.value">
                          </label>
