...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/withdraw.css">
  ...
  <div id="wrap">
    <div id="container">
      ...
      <div class="main_content">
        ...
        <div style="padding:20px; width:50vw;text-align: left; color:#717171;
              font-size:12px; font-weight: bold; border:#d9d9d9 solid 2px; ">
          Treesoap 탈퇴안내<br /><br />
        ...
        <form id="joinform" class="joinform" method="POST" action="/treesoap/withdraw_process.php">
          <input type="hidden" name="a" value="1" />
          <table style="width:52vw; border-left:white; ">
            <tr width="100%">
              <th style="border-left:white;" bgcolor="#f0ffe5">비밀번호</th>
              <td colspan="2" style="border-right:white;"><input type=password name="userpw"></td>
            </tr>
            <tr width="100%" style="line-height:25px;">
              <th style="border-left:white;" bgcolor="#f0ffe5">탈퇴사유</th>
              <td width="30%" style=" border-right:white;">
                <p><input type=checkbox> 고객서비스(상담,포장 등) 불만 </p>
                <p><input type=checkbox> 배송불만 </p>
                <p><input type=checkbox> 교환/환불/반품 불만 </p>
                <p><input type=checkbox> 방문 빈도가 낮음 </p>
              </td>

              <td style="padding-top:0.1px;border-right:white; border-left:white;">

                <span>
                  <input type=checkbox> 상품가격 불만 </span><br /><span><input type=checkbox> 개인 정보유출 우려 </span><br /><span><input type=checkbox> 쇼핑몰의 신뢰도 불만
                </span>
            ...
            <tr>
              <th style="border-left:white;" bgcolor="#f0ffe5">남기실 말씀</th>
              <td colspan="2" style="border-right:white;">
                <textarea style="box-sizing: border-box; padding:10px" cols="80" rows="8"></textarea>
              </td>
            </tr>
          </table>
          <div class="blink"></div>
          <div style="padding-left:70px; margin-top:40px;">
            <center>
              <button class="button7" style="background-color: #a4d18e" onclick="event.preventDefault(); location.href='/treesoap/mypage.php'">취소</button>
              <button class="button6" style="background-color: #6fa56f">탈퇴</button>
            </center>
          </div>
        </form>
      </div>
