...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/find_password2.css">
...
<body>
  ...
  <div class="content">
    <div class="main_left_btn" id="byemail">
      <center>
        <form action="/treesoap/find_password_process2.php" id="find_password2form" class="find_password2form" method="POST">
          <div class="title">
            <h3>l 이메일 주소로 비밀번호 찾기</h3>
          </div>
          <div class="form">
            <br>회원가입한 이메일 주소를 입력해주세요.

            <div class="blank"></div>
            <input type=text name="email" id="email">
          </div>
          <div class="blank"></div>
          <a style="border:none; background-color:white;text-decoration: underline; cursor:pointer; " onclick="document.getElementById('byemail').style.display='none';document.getElementById('bytel').style.display='block'">휴대폰번호로 비밀번호 찾기</a>
          <button class="button6" style="background-color: #a4d18e">확인</button>
      </center>
    </div>
    <div class="main_right_btn" id="bytel">
      <center>
        <div class="title">
          <h3>l 휴대폰번호로 비밀번호 찾기</h3>
        </div>
        <div class="form">
          <br>회원가입한 핸드폰 번호를 입력해주세요.
          <div class="blank"></div>

          <input type=text name="tel" id="tel" placeholder=" - 없이 입력하세요.">
        </div>
        <div class="blank"></div>
        <a style="border:none; background-color:white; text-decoration: underline; cursor:pointer;" onclick="document.getElementById('byemail').style.display='block';document.getElementById('bytel').style.display='none'">이메일 주소로 비밀번호 찾기</a>
        <button class="button6" style="background-color: #a4d18e">확인</button>
        </form>
      </center>
    </div>
