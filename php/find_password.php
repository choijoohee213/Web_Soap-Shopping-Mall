...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/find_password.css">
...
<body>
  ...
  <div class="content">
    <center>
      ...
      <div class="form">
        <form action="/treesoap/find_password_process.php" id="find_passwordform" class="find_passwordform" method="POST">
          <div class="input">
            <input style="width:190px; height:37px; margin:16px 0 0 10px;" placeholder="아이디 입력" name="userid" type="text" value="" required>
          </div>
      ...
      <div class="btn-group7">
        <button class="button7" style="background-color: #6fa56f">회원가입</button>
        <button class="button7" style="background-color: #a4d18e">아이디찾기</button>
      </div>
