...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/treesoap/css/mypage.css">
...
<body>
  ...
  <div id="wrap">
    <div id="container">
      <div>
        <img src="https://lush.co.kr/data/skin/front/howling/img/sub/bg_article.jpg" style="width:100%; height:350px;" />
      </div>
      ...
      <div class="main_content">
        ...
        <div style="margin-left:15pt;">
          ...
          <p style="margin-bottom:7pt;color:gray; font-size:30px;  font-weight:bold;">
            <?=$username?>님,</p>
          <p style=" margin-bottom:7pt; color:#333333; font-size:25px; font-weight:bold;">
            오늘도 <span style="color:#44bf6e;">트리솝</span>을 방문해주셔서 감사합니다.
          </p><img src="/treesoap/img/logo.png" style="float:left; margin-top:50px;" width="300vw"><br /><br /><br /><br />
          <p style="margin-top:40pt; margin-bottom:7pt; color:#4d4d4d; font-size:20px; font-weight:bold;">
            회원님의 등급은 <span style="color:#44bf6e;">패밀리 등급</span>입니다.
          </p>
          <p style="margin-bottom:7pt; color:#4d4d4d; font-size:20px; font-weight:bold;">
            왼쪽의 세부메뉴를 이용해주세요.
          </p>
